...
from .views import artistView,favoriteView,userView,adminViews,albumView,songView,authView,adminView, testView, statView, playlistView
...
urlpatterns = [
    ...
    # #ADMIN
    path('api/admin/check',adminView.check_admin, name='admin_check'),
